...
EventBoard
<div class="event-board"> eventBoar используем это назвыние в класе , а не "event-boar ,,,,, "Event cards</div>
.eventBoard {
  display: grid;
...
formatDistanceStrict(Date.parse(start), Date.parse(end)); }; import Z from
'common/components/Z' import X from 'common/components/X' import Y from
'common/components/Y'

import {Z, X, Y} from 'common/components'

src modules common components Z X Y index.js courses components A B C groups
components D E homeworks components F -->
